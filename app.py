...
def create_task():
    ...
    return jsonify({ "message": "New task has been created", "id": new_task.id})
...
def get_task(id):
    ...
    return jsonify({ "message: Cannot found the task" }), 404
...
def update_task(id):
    ...
    return jsonify({"message": "Task has been updated successfully"})
